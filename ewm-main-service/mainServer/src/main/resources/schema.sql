...
drop type  IF EXISTS state_enum, event_request_status_enum;
...
create type  state_enum as ENUM ('PENDING', 'PUBLISHED', 'CANCELED');
...
create type  event_request_status_enum as ENUM ('PENDING', 'CONFIRMED', 'REJECTED');
create table if not exists event_requests (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    created timestamp WITHOUT TIME ZONE NOT NULL,
    event_id BIGINT NOT NULL REFERENCES events(id),
    requester_id BIGINT NOT NULL REFERENCES users(id),
    status event_request_status_enum NOT NULL,
